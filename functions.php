...
function avontec_theme_scripts() {
	...
	/*light gallery */
    wp_enqueue_script( 'avontec_theme-lightgallerymin', get_template_directory_uri() . '/js/js-min/lightgallery.min.js', array('jquery'), '20190322', true );
    wp_enqueue_script( 'avontec_theme-lightboxjs', get_template_directory_uri() . '/js/lightbox.js', array('jquery'), '20190322', true );

    wp_enqueue_style( 'avontec_theme-transitioncss', get_stylesheet_directory_uri() . '/css/lg-transitions.min.css', '', '20190322', 'all');

    wp_enqueue_style( 'avontec_theme-lightgallerymin', get_stylesheet_directory_uri() . '/css/lightgallery.min.css', '', '20190322','all');
